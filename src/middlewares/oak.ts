import type { Context, Middleware, CookiesGetOptions, CookiesSetDeleteOptions } from 'oak'
...
export interface SessionMiddlewareConfig extends Omit<
  SessionConfig<
    Context['cookies'],
    CookiesGetOptions & CookiesSetDeleteOptions,
    CookiesGetOptions,
...
/**
 * Oak session middleware. Conforms to the deliberate sessions model by only loading existing sessions.
 */
